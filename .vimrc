...
" --- Fix for broken highlighting on '..' in Python files ---
augroup python_fix
  autocmd!
  autocmd FileType python syntax clear pythonString
  autocmd FileType python syntax region pythonString start=+'+ skip=+\\\\'+ end=+'+ contains=pythonEscape,@Spell
  autocmd FileType python syntax region pythonString start=+"+ skip=+\\\\\"+ end=+"+ contains=pythonEscape,@Spell
augroup END
